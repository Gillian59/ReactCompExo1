...
function askNumber (text, reader){ 
  reader.question(text , (number) => { 
    if (number<1 && number>100) {console.log("The number is between 1 and 100");}
    else if (number<numberToFind){console.log("Too low");}
    else if (number>numberToFind){console.log("Too high");}
    else if (number === number){console.log("You won!");}
